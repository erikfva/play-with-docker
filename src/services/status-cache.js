 ...
 * Only non-UNKNOWN results are cached. Throws are never cached (caller converts to UNKNOWN).
 * LIMITED is never returned by a checker, so it never enters the cache.
 */
